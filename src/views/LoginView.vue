  ...
  <div class="login-page">
    ...
    <div class="login-card">
      <header class="login-card__header">
        ...
        <p class="login-card__subtitle">Espace membres et gestion du cercle</p>
      </header>
      ...
      <div class="login-card__member">
        <span class="login-card__member-label">Pas encore de compte ?</span>
        <v-btn variant="tonal" block class="text-none mt-2" to="/inscription">
...
async function submit() {
  ...
  try {
    ...
    router.replace(redirect.startsWith('/') ? redirect : homePath(auth.user))
  } catch (err) {
